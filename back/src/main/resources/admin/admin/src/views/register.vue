        ...
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                ...
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="企业联系方式" class="input" v-if="tableName=='qiye'">
                            <el-input v-model="ruleForm.qiyePhone" autocomplete="off" placeholder="企业联系方式"  />
                        </el-form-item>
                        <el-form-item label="企业邮箱" class="input" v-if="tableName=='qiye'">
                            <el-input v-model="ruleForm.qiyeEmail" autocomplete="off" placeholder="企业邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.qiyeName)&& 'qiye'==this.tableName){
                                this.$message.error('企业名称不能为空');
                                return
                            }
                             if('qiye' == this.tableName && this.ruleForm.qiyePhone&&(!this.$validate.isMobile(this.ruleForm.qiyePhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('qiye' == this.tableName && this.ruleForm.qiyeEmail&&(!this.$validate.isEmail(this.ruleForm.qiyeEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
