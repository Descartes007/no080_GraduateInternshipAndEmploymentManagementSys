    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公告名称" prop="gonggaoLaoshiName">
                       <el-input v-model="ruleForm.gonggaoLaoshiName"
                                 placeholder="公告名称" clearable  :readonly="ro.gonggaoLaoshiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="公告名称" prop="gonggaoLaoshiName">
                           <el-input v-model="ruleForm.gonggaoLaoshiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="公告类型" prop="gonggaoLaoshiTypes">
                        <el-select v-model="ruleForm.gonggaoLaoshiTypes" :disabled="ro.gonggaoLaoshiTypes" placeholder="请选择公告类型">
                            <el-option
                                v-for="(item,index) in gonggaoLaoshiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="公告类型" prop="gonggaoLaoshiValue">
                        <el-input v-model="ruleForm.gonggaoLaoshiValue"
                            placeholder="公告类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="公告详情" prop="gonggaoLaoshiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gonggaoLaoshiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gonggaoLaoshiContent" label="公告详情" prop="gonggaoLaoshiContent">
                            <span v-html="ruleForm.gonggaoLaoshiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    laoshiId: false,
                    gonggaoLaoshiName: false,
                    gonggaoLaoshiTypes: false,
                    insertTime: false,
                    gonggaoLaoshiContent: false,
                },
                ruleForm: {
                    laoshiId: '',
                    gonggaoLaoshiName: '',
                    gonggaoLaoshiTypes: '',
                    insertTime: '',
                    gonggaoLaoshiContent: '',
                },
                gonggaoLaoshiTypesOptions : [],
                laoshiOptions : [],
                rules: {
                   laoshiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gonggao_laoshi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gonggaoLaoshiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`gonggaoLaoshi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.gonggaoLaoshiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
