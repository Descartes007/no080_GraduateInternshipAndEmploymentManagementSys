    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="qiyeId" name="qiyeId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="入职时间" prop="jiuyeKaishiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jiuyeKaishiTime"
                                type="datetime"
                                placeholder="入职时间"
                                :disabled="ro.jiuyeKaishiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiuyeKaishiTime" label="入职时间" prop="jiuyeKaishiTime">
                            <span v-html="ruleForm.jiuyeKaishiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="入职岗位" prop="jiuyeGangweiName">
                       <el-input v-model="ruleForm.jiuyeGangweiName"
                                 placeholder="入职岗位" clearable  :readonly="ro.jiuyeGangweiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="入职岗位" prop="jiuyeGangweiName">
                           <el-input v-model="ruleForm.jiuyeGangweiName"
                                     placeholder="入职岗位" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiuyeFile" label="相关文件" prop="jiuyeFile">
                        <file-upload
                                tip="点击上传相关文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.jiuyeFile?ruleForm.jiuyeFile:''"
                                @change="jiuyeFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiuyeFile" label="相关文件" prop="jiuyeFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.jiuyeFile"  >相关文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="就业备注" prop="jiuyeContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jiuyeContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiuyeContent" label="就业备注" prop="jiuyeContent">
                            <span v-html="ruleForm.jiuyeContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    qiyeId: false,
                    jiuyeKaishiTime: false,
                    jiuyeGangweiName: false,
                    jiuyeFile: false,
                    jiuyeContent: false,
                    insertTime: false,
                },
                ...
                rules: {
                   ...
                   jiuyeContent: [
                              { required: true, message: '就业备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiuye/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiuyeCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            jiuyeFileUploadChange(fileUrls){
                this.ruleForm.jiuyeFile = fileUrls;
                this.addEditUploadStyleChange()
            },
