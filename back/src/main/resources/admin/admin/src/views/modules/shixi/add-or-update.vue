    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='qiye' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.qiyePhoto" label="企业图片" prop="qiyePhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (qiyeForm.qiyePhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.qiyePhoto" label="企业图片" prop="qiyePhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.qiyePhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='qiye' ">
                    <el-form-item class="input" v-if="type!='info'"  label="企业联系方式" prop="qiyePhone">
                        <el-input v-model="qiyeForm.qiyePhone"
                                  placeholder="企业联系方式" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="企业联系方式" prop="qiyePhone">
                            <el-input v-model="ruleForm.qiyePhone"
                                      placeholder="企业联系方式" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='qiye' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所在行业" prop="qiyeValue">
                        <el-input v-model="qiyeForm.qiyeValue"
                                  placeholder="所在行业" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="所在行业" prop="qiyeValue">
                            <el-input v-model="ruleForm.qiyeValue"
                                      placeholder="所在行业" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="qiyeId" name="qiyeId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="实习开始时间" prop="shixiKaishiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.shixiKaishiTime"
                                type="datetime"
                                placeholder="实习开始时间"
                                :disabled="ro.shixiKaishiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shixiKaishiTime" label="实习开始时间" prop="shixiKaishiTime">
                            <span v-html="ruleForm.shixiKaishiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="实习结束时间" prop="shixiJieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.shixiJieshuTime"
                                type="datetime"
                                placeholder="实习结束时间"
                                :disabled="ro.shixiJieshuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shixiJieshuTime" label="实习结束时间" prop="shixiJieshuTime">
                            <span v-html="ruleForm.shixiJieshuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="实习结果" prop="shixiJieguoTypes">
                        <el-select v-model="ruleForm.shixiJieguoTypes" :disabled="ro.shixiJieguoTypes" placeholder="请选择实习结果">
                            <el-option
                                v-for="(item,index) in shixiJieguoTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="实习结果" prop="shixiJieguoValue">
                        <el-input v-model="ruleForm.shixiJieguoValue"
                            placeholder="实习结果" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实习岗位" prop="shixiGangweiName">
                       <el-input v-model="ruleForm.shixiGangweiName"
                                 placeholder="实习岗位" clearable  :readonly="ro.shixiGangweiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="实习岗位" prop="shixiGangweiName">
                           <el-input v-model="ruleForm.shixiGangweiName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="实习详情" prop="shixiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shixiContent" label="实习详情" prop="shixiContent">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    shixiName: false,
                    shixiTypes: false,
                    shixiKaishiTime: false,
                    shixiJieshuTime: false,
                    shixiJieguoTypes: false,
                    shixiGangweiName: false,
                    shixiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                ...
                rules: {
                   ...
                   shixiJieguoTypes: [
                              { required: true, message: '实习结果不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shixiContent: [
                              { required: true, message: '实习详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shixi_jieguo_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shixiJieguoTypesOptions = data.data.list;
                    }
                });
